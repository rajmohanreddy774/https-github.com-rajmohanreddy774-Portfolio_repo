						...
						<Row>
							<Col lg={4} sm={12}>
								...
								>
												...
												<div className="flip-card-front">
													...
													<Card.Body>
													 ...
													 Boat-lifestyle.com/(Clone)
														...
														<Card.Text>
															<p align="center">
															An e-commerce shopping website that sells earphones, headphones, portable chargers, and premium tough cables
															</p>
														</Card.Text>
													</Card.Body>
												</div>
									...
									<div>
										<a
											href="https://admiring-clarke-35d7b9.netlify.app/"
											target="_blank"
										...
										<a
											href="https://github.com/rajmohanreddy774/boAt-lifestyle"
											target="_blank"
											rel="noreferrer noopener"
										>
											<Button
							...
							<Col lg={4} sm={12}>
								...
								>
										...
										<div class="flip-card">
											<div class="flip-card-inner">
												<div className="flip-card-front">
													...
													<Card.Body>
														<Card.Title align="center">
														Shoppersstop.com(Clone)
														</Card.Title>
														<Card.Text>
															<p align="center">
															 Shoppersstop is an fashion e-commerce website for Clothing for Men, Women & Kids.
												...
												<div className="flip-card-back">
													<p>
													Shoppers Stop stores sell international and national brands of clothing for men, women, and children, as well as accessories, fragrances, cosmetics, footwear, and home furnishings and decor.
													</p>
													<Button
														variant={
															darkMode
									...
									<div>
										<a
											href="https://unit4-project-harsh.netlify.app/"
											target="_blank"
											rel="noreferrer noopener"
										>
											<Button
										...
										<a
											href="https://github.com/Harsh244007/UNIT4-PROJECT-SHOPPERS-STOP"
											target="_blank"
											rel="noreferrer noopener"
										>
											<Button
